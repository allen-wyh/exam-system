    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_partin_num', models.IntegerField(default=0, help_text='总参与人数', verbose_name='总参与人数')),
            ],
            options={
                'verbose_name': '比赛类别信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qa_id', models.IntegerField(blank=True, db_index=True, help_text='QA 唯一标识', max_length=32, null=True, verbose_name='问题id')),
                ('uid', models.CharField(blank=True, db_index=True, help_text='用户唯一标识', max_length=32, null=True, verbose_name='用户id')),
                ...
                ('correct_list', models.CharField(blank=True, help_text='正确答案列表', max_length=10000, null=True, verbose_name='正确答案列表')),
                ('wrong_list', models.CharField(blank=True, help_text='错误答案列表', max_length=10000, null=True, verbose_name='错误答案列表')),
